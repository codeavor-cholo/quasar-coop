        ...
        >
            <template v-slot:top>
                <div class="fit yesPrint">
                    <div class="text-h6 row justify-between fit q-mb-md">
                        <div>
                            ...
                            <div class="text-caption">Prepared By: {{returnLogged.displayName}}</div>
                        </div>
                ...
                <div class="fit noPrint">
                    <q-btn color="grey-10" icon="print" label="print report" @click="printWholeReport = true" class="float-right"/>
...
export default {
    ...
    data(){
        return{
            ...
            filter: '',
            adjustDate: false,
            today: date.formatDate(new Date(2020,5,16),'MM-DD-YYYY'),
            data: [],
            selected: {},
            columns: [
    ...
    computed:{
        ...
        returnSumDailyCollections(){
            let sum = this.$lodash.sumBy(this.returnDailyCollections,'Total')
            return sum
        },
